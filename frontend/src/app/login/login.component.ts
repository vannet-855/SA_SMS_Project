...
export class LoginComponent {
  ...
  autofillRole(role: typeof this.selectedRole): void {
    this.selectRole(role);

    switch (role) {
      case 'Administrator':
        this.username = 'admin@school.com';
        break;
      case 'Teacher':
        this.username = 'teacher@school.com';
        break;
      case 'Student':
        this.username = 'student@school.com';
        break;
      case 'Parent / Guardian':
        this.username = 'parent@school.com';
        break;
    }
  }
